		             ...
		             <s:message code="p.major"/>:
	                  ...
	                  <s:message code="p.status"/>:
						...
						data-options="
	                    	...
	                    	multiple:true
	                    ">
				<a href="javascript:$.ad.gridQuery('student_query_form','student_grid')"
					class="easyui-linkbutton" iconCls="icon-search"><s:message
						code="comm.query" /></a>
				<a href="javascript:void(0)"
						class="easyui-linkbutton" onclick="$.ad.clearForm('student_query_form')"
						style="width: 80px"><s:message code="comm.clear" /></a>
			</form>
		</div>
	</div>

	<table class="easyui-datagrid" id="student_grid" style="width:100%;"
