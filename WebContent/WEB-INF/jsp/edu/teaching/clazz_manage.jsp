...
<body>
	...
	<div id="clazz_tb" style="padding: 5px; height: auto">
		<div style="margin-bottom: 5px">
			<a href="javascript:$.ad.toAdd('clazz_w','班级','clazz_add','${ctx }/clazz/add');" class="easyui-linkbutton" 
				iconCls="icon-add" plain="true"><s:message code='comm.add' /></a> 
			<a href="javascript:$.ad.toUpdate('clazz_grid','clazz_w','班级','clazz_add','${ctx }/clazz/update')"
		...
		<form id="clazz_query_form">
			    ...
			    <a href="javascript:void(0)"
						class="easyui-linkbutton" onclick="$.ad.clearForm('clazz_query_form')"
						style="width: 80px"><s:message code="comm.clear" /></a> 
			</form>
		</div>
	</div>

	<table class="easyui-datagrid" id="clazz_grid" style="width: 1020px;"
		data-options="rownumbers:true,singleSelect:false,pagination:true,multiSort:true,selectOnCheck:true,
				url:'${ctx }/clazz/list',method:'post',toolbar:'#clazz_tb'">
		<thead>
			<tr>
				<th data-options="field:'ck',checkbox:true"></th>
				<th data-options="field:'name',width:100,sortable:'true'"><s:message
						code="clazz.name" /></th>
	...
	<div id="clazz_w" class="easyui-window" title='<s:message code="user.add" />'
				...
				<form id="clazz_add" method="post" action="${ctx }/clazz/add">
					<div style="margin-bottom: 20px">
						<input class="easyui-textbox" name="name" style="width: 100%"
							data-options="label:'<s:message code="clazz.name"/>:'" />
					</div>
					<div style="margin-bottom: 20px">
