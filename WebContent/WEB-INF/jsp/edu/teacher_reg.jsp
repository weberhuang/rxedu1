...
<body>
	...
	<div id="teacher_w" class="easyui-panel"
		style="width: 90%; height: 100%; padding: 10px;">
				...
				<form id="teacher_add" method="post" action="${ctx }/teacher/update">
					...
					<table style="width:100%;border:1px solid #ccc;">
						<tr>
							...
							<td>
								<input class="easyui-textbox" name="name" style="width: 170px" value="${data.name }"
							...
							<td>
								<input class="easyui-combobox" name="sex" style="width: 170px"
									data-options="
							...
							<td>
								<input class="easyui-datebox" name="birthday" style="width: 170px"
								data-options="required:true">
							</td>
						</tr>
						<tr>						
							...
							<td>
								<input class="easyui-textbox" name="phone" style="width: 170px"
								data-options="required:true,validType:'maxLength[30]'">
							</td>
							
							<td>QQ:</td>	
							<td>
								<input class="easyui-textbox" name="qq" style="width: 170px"
								data-options="required:true,validType:'maxLength[20]'">
							</td>
							
							<td>Email:</td>
							<td>
								<input class="easyui-textbox" name="email" style="width: 170px"
						...
						<tr>
							...
							<td>
								<input class="easyui-datebox" name="entryTime" style="width: 170px"
								data-options="required:true">
							</td>
						</tr>
						<tr>
					...
					<table style="width:100%;border:1px solid #ccc;">
						<tr>
							...
							<td>
								<input class="easyui-combobox" name="education" style="width: 130px"
									data-options="
							...
							<td>
								<input class="easyui-textbox" name="school" style="width: 130px"
									data-options="required:true,validType:'maxLength[60]'">
							</td>
							
							<td><s:message code="p.major"/>:</td>
							<td>
								<input class="easyui-textbox" name="major" style="width: 130px"
									data-options="required:true,validType:'maxLength[30]'">
							</td>
							
							<td><s:message code="p.graduateTime"/>:</td>
							<td>
								<input class="easyui-datebox" name="graduateTime" style="width: 130px"
								data-options="required:true">
							</td>
						</tr>
					</table>
