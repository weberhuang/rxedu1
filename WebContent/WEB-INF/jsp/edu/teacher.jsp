...
<body>
		...
		var teacher = {
                ...
                onExpandRow: function(index,row){
                    ...
                    if(row.addDetail){
						...
						'<tr>' +
							'<th style="width:150px"><s:message code="p.emeContInfo"/></th>'+
							'<th class="dv-label" style="width:150px"><s:message code="p.emeContact"/>:</th>' +
							'<td>' + $.ad.nvl(row.emeContact) + '</td>' +
							
							'<th class="dv-label" style="width:150px"><s:message code="p.emeContactPhone"/>:</th>' +
						...
						'<tr>' +
							'<th style="width:150px"><s:message code="teacher.course"/></th>'+
							'<td colspan="8">';
					...
					name="name_like_string">
	                  ...
	                  <s:message code="p.status"/>:
						...
						data-options="
	                    	...
	                    	multiple:true
	                    ">
				<a href="javascript:$.ad.gridQuery('teacher_query_form','teacher_grid')"
					class="easyui-linkbutton" iconCls="icon-search"><s:message
						code="comm.query" /></a>
				<a href="javascript:void(0)"
						class="easyui-linkbutton" onclick="$.ad.clearForm('teacher_query_form')"
						style="width: 80px"><s:message code="comm.clear" /></a>
			</form>
		</div>
	</div>

	<table class="easyui-datagrid" id="teacher_grid" style="width: 100%;"
	...
	<div id="teacher_w" class="easyui-window"
		...
		style="width: 80%; height: 500px; padding: 10px;">
				...
				<form id="teacher_add" method="post" action="${ctx }/teacher/add">
					...
					<table style="width:100%;border:1px solid #ccc;">
						<tr>
							...
							<td>
								<input class="easyui-combobox" name="sex" style="width: 150px"
									data-options="
							...
							<td>
								<input class="easyui-datebox" name="birthday" style="width: 150px"
								data-options="required:true">
							</td>
						</tr>
						<tr>						
							...
							<td>QQ:</td>	
							<td>
								<input class="easyui-textbox" name="qq" style="width: 150px"
								data-options="required:true,validType:'maxLength[20]'">
							</td>
							
							<td>Email:</td>
							<td>
								<input class="easyui-textbox" name="email" style="width: 150px"
						...
						<tr>		
							...
							<td>
								<input class="easyui-datebox" name="entryTime" style="width: 150px"
								data-options="required:true">
							</td>
							
							<td><s:message code="teacher.leaveTime"/>:</td>
							<td>
								<input class="easyui-datebox" name="leaveTime" style="width: 150px">
							</td>
						</tr>
						<tr>
					...
					<table style="width:100%;border:1px solid #ccc;">
						<tr>
							...
							<td>
								<input class="easyui-combobox" name="education" style="width: 125px"
									data-options="
							...
							<td>
								<input class="easyui-textbox" name="school" style="width: 125px"
									data-options="required:true,validType:'maxLength[60]'">
							</td>
							
							<td><s:message code="p.major"/>:</td>
							<td>
								<input class="easyui-textbox" name="major" style="width: 125px"
									data-options="required:true,validType:'maxLength[30]'">
							</td>
							
							<td><s:message code="p.graduateTime"/>:</td>
							<td>
								<input class="easyui-datebox" name="graduateTime" style="width: 125px"
								data-options="required:true">
							</td>
						</tr>
					</table>
					...
					<table style="width:100%;border:1px solid #ccc;">
						<tr>
							...
							<td>
								<input class="easyui-combobox" name="courseIds" style="width: 450px" id="teacher_courseIds"
									data-options="
				                    url:'${ctx }/course/list?sort=type&order=asc&type=c',
				                    method:'get',
				                    valueField:'id',
				                    textField:'name',
				                    panelHeight:'auto',
