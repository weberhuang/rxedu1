				...
				<form id="student_add" method="post" action="${ctx }/student/add">
					...
					<table style="width:100%;border:1px solid #ccc;">
						<tr>
							...
							<td>
								<input class="easyui-textbox" name="name" style="width: 150px" value="${data.name }"
						...
						<tr>
							...
							<td>
								<input class="easyui-combobox" name="clazz" style="width: 150px"  value="${data.clazz }"
							...
							<td>
								<input class="easyui-datebox" name="startTime" style="width: 150px" value="${data.startTime}"
								data-options="required:true">
							</td>
						...
						<tr>
							...
							<td>
								<input class="easyui-textbox" name=secondContact style="width: 150px"
								data-options="required:true,validType:'maxLength[50]'">
							</td>
						</tr>
						<tr>
					...
					<table style="width:100%;border:1px solid #ccc;">
						<tr>
							...
							<td>
								<input class="easyui-combobox" name="education" style="width: 150px"
									data-options="
							...
							<td>
								<input class="easyui-textbox" name="school" style="width: 150px"
									data-options="required:true,validType:'maxLength[60]'">
							</td>
							
							<td><s:message code="p.major"/>:</td>
							<td>
								<input class="easyui-textbox" name="major" style="width: 150px"
									data-options="required:true,validType:'maxLength[30]'">
							</td>
							
							<td><s:message code="p.graduateTime"/>:</td>
							<td>
								<input class="easyui-datebox" name="graduateTime" style="width: 150px"
								data-options="required:true">
							</td>
						</tr>
					</table>
