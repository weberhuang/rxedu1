		...
		<div data-options="region:'center',border:false" style="width:300px;max-height:430px;padding-left:30px"> 
			<div class="content">
				<form id="course_add" method="post" action="${ctx }/course/add">							
					...
					<div style="margin-bottom: 20px" id="teacherDiv">
					    <input class="easyui-combobox" name="teacher" style="width: 240px"  id = "teacher"
							data-options="label:'老师',url:'${ctx }/teacher/list?status=s',
			                    method:'get',
			                    valueField:'id',
			                    textField:'name',
			                    required:true">			                    
					...
					$('#' + formId).form('submit',{success:function(data){
						...
						$.sm.handleResult(data,function(node){
							...
							if(newNode.pid == course.currNode.id){
								...
								course.currNode.teacher = newNode.teacher;
